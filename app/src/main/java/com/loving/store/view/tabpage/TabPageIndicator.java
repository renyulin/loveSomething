...
//                smoothScrollTo(scrollPos, 0);
    ...
    private void addTab(int index, CharSequence text, int iconResId) {
        ...
        final TabView tabView = (TabView) mInflater.inflate(R.layout.tab_item, null);
        ImageView icon = (ImageView) tabView.findViewById(R.id.icon);

        tabView.mIndex = index;
        tabView.setFocusable(true);
        tabView.setOnClickListener(mTabClickListener);
        ((TextView) tabView.findViewById(R.id.text)).setText(text);  //tab文字
        if (iconResId != 0) {
        ...
        mTabLayout.addView(tabView, new LayoutParams(width / 3, getResources().getDimensionPixelSize(R.dimen.menu_height), 1));
    }
