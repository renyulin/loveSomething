...
public class SuperSwipeRefreshLayout extends ViewGroup {
    ...
    private boolean isFootEnable = true;


    public boolean isFootEnable() {
        return this.isFootEnable;
    }

    public void setIsFootEnable(boolean isFootEnable) {
    ...
    public void setIsHeadEnable(boolean isHeadEnable) {
        this.isHeadEnable = isHeadEnable;
    }
